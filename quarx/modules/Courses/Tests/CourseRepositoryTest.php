...
class CourseRepositoryTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->repo = $this->app->make(CourseRepository::class);
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals(get_class($response), 'App\Repositories\Course\Course');
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals(1, $response->id);
        $this->seeInDatabase('courses', $this->editedArray);
    }
